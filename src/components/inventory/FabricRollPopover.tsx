...
interface FabricRollPopoverProps {
  roll: FabricRoll;
  children: React.ReactNode;
}

const FabricRollPopover: React.FC<FabricRollPopoverProps> = ({
  roll,
  children,
}) => {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[800px] p-0 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1e1e2d]">
        <div className="p-6">
...
export default FabricRollPopover;
