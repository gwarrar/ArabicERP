  ...
  const transactions = [
    {
      ...
      description: "فاتورة مشتريات - ملابس شتوية",
      debit: 105000,
      credit: 0,
      balance: 105000,
    },
    ...
    },
    {
      ...
      description: "فاتورة مشتريات - إكسسوارات",
      debit: 35000,
      credit: 0,
      balance: 90000,
    },
    {
      ...
      date: "2023-12-25",
      type: "دفعة",
      reference: "PAY-2023-0102",
      description: "دفعة كاملة - فاتورة INV-2023-0145",
      debit: 0,
      credit: 35000,
      balance: 55000,
    },
    {
      ...
      date: "2024-01-10",
      type: "دفعة",
      reference: "PAY-2024-0012",
      description: "دفعة نهائية - فاتورة INV-2023-0123",
      debit: 0,
      credit: 55000,
      balance: 0,
    },
    ...
    <Dialog open={open} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            عرض بيانات المورد {supplier.name}
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="invoices" className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-medium">فواتير المشتريات</h3>
              <div className="flex gap-2">
                <Button variant="outline" size="sm">
                  <Download className="h-4 w-4 ml-1" />
                  تصدير
          ...
          <TabsContent value="containers" className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-medium">الكونتينرات</h3>
              <div className="flex gap-2">
                <Button variant="outline" size="sm">
                  <Download className="h-4 w-4 ml-1" />
                  تصدير
            ...
            <div className="border rounded-lg overflow-hidden">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead>رقم الكونتينر</TableHead>
                ...
                <TableBody>
                  {containers.map((container) => (
                    <TableRow key={container.id}>
                      ...
                      <TableCell className="text-center">
                        {container.value.toLocaleString()} ₴
                      </TableCell>
                      <TableCell className="text-center">
                        <Badge
                          className={
                            container.status === "مكتمل"
                              ? "bg-green-100 text-green-800"
          ...
          <TabsContent value="stats" className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-medium">إحصائيات المورد</h3>
              <div className="flex gap-2">
                <Button variant="outline" size="sm">
                  <Download className="h-4 w-4 ml-1" />
                  تصدير
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>
                        {(totalPurchases / invoices.length).toLocaleString()} ₴
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {((totalPaid / totalPurchases) * 100).toFixed(1)}%
                      </span>
                    </div>
                  </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-blue-800">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    يمكنك الحصول على تقارير مفصلة عن هذا المورد من خلال قسم
                    التقارير. تتضمن التقارير تحليلات للمشتريات والمدفوعات
                    والكونتينرات على مدار فترات زمنية مختلفة.
                  </p>
                </div>
              </div>
            </div>
