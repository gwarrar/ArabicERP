...
const PrintTemplates = () => {
  ...
  const filteredTemplates = currentTemplates.filter(
    (template) =>
      template.name.includes(searchQuery) || template.id.includes(searchQuery),
  );
    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <Card className="md:col-span-2">
                <CardHeader>
                  ...
                  <CardDescription>
                    معاينة النموذج قبل الطباعة أو التعديل
                  </CardDescription>
                </CardHeader>
                    ...
                    <div className="border rounded-md p-4 w-full h-[400px] overflow-auto bg-white">
                      ...
                      {selectedTemplate.type === "عقد" && (
                        <div className="p-4">
                          ...
                          <p className="mb-4">
                            تم الاتفاق في يوم 10 أغسطس 2024 بين كل من:
                          </p>
                          <p className="mb-2">
                            <strong>الطرف الأول:</strong> شركة الأفق للتجارة،
                            ومقرها الرياض، المملكة العربية السعودية.
                          </p>
                          <p className="mb-4">
                            <strong>الطرف الثاني:</strong> شركة المستقبل
                            للتقنية، ومقرها جدة، المملكة العربية السعودية.
                          </p>
                          ...
                          <p className="mb-4">
                            اتفق الطرفان على أن يقوم الطرف الأول بتوريد منتجات
                            ملابس للطرف الثاني وفقاً للمواصفات والكميات المتفق
                            عليها.
                          </p>
                          ...
                          <p className="mb-4">
                            مدة هذا العقد سنة ميلادية كاملة تبدأ من تاريخ 10
                            أغسطس 2024 وتنتهي في 9 أغسطس 2025.
                          </p>
                          ...
                          <p className="mb-4">
                            قيمة هذا العقد ₴ 250,000 (مائتان وخمسون ألف) تدفع
                            على أربعة أقساط متساوية كل ثلاثة أشهر.
                          </p>
                          ...
                          <p className="mb-4">
                            يلتزم الطرف الأول بتوريد المنتجات المتفق عليها وفقاً
                            للمواصفات والجودة المطلوبة وفي المواعيد المحددة.
                          </p>
                          ...
                          <p className="mb-4">
                            يلتزم الطرف الثاني بسداد قيمة العقد في المواعيد
                            المتفق عليها واستلام البضائع وفحصها.
                          </p>
                      ...
                      {selectedTemplate.type === "تقرير" && (
                        <div className="p-4">
                          ...
                          <div className="mb-6">
                            ...
                            <p className="mb-4">
                              يقدم هذا التقرير تحليلاً شاملاً لأداء المبيعات
                              خلال شهر يوليو 2024، مع مقارنة بالأشهر السابقة
                              وتحديد الاتجاهات الرئيسية.
                            </p>
                          </div>
                          ...
                          <div className="mb-6">
                            ...
                            <p className="mb-2">
                              إجمالي المبيعات لشهر يوليو: ₴ 325,430
                            </p>
                            <p className="mb-2">
                              نسبة النمو عن الشهر السابق: 12.5%
                            </p>
                            <p className="mb-2">
                          ...
                          <div className="mb-6">
                            ...
                            <ul className="list-disc pr-6">
                              <li className="mb-1">
                                زيادة المخزون من القمصان القطنية لتلبية الطلب
                                المتزايد
                              </li>
                              <li className="mb-1">
                                مراجعة استراتيجية تسويق البلوزات الحريرية لتحسين
                                المبيعات
                              </li>
                              <li className="mb-1">
                          ...
                          <div className="mt-8 pt-4 border-t">
                            <p className="text-sm text-gray-600 text-center">
                              تم إعداد هذا التقرير بواسطة قسم المبيعات - شركة
                              الأفق للتجارة
                            </p>
                          </div>
                        </div>
                          ...
                          <div className="mb-6">
                            <table className="w-full border-collapse mb-4">
                              <tbody>
                                <tr>
                                  <td
                                    className="border p-2 bg-gray-50 font-bold"
                                    width="30%"
                                  >
                                    المستلم / المسلم:
                                  </td>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    المتغيرات التي يمكن استخدامها في النموذج
                  </CardDescription>
                </CardHeader>
                <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            تحرير وتخصيص النماذج باستخدام محرر النماذج المتقدم
          </CardDescription>
        </CardHeader>
        <CardContent>
